...
const avatarImages = {
  basic: '/images/avatars/basic.png',
  novice: '/images/avatars/novice.png',
  rising: '/images/avatars/rising.png',
  elite: '/images/avatars/elite.png',
  onepunch: '/images/avatars/onepunch.png',
};
